...
# CHANGEME #
OUT=../results/merge.IDT-samples_TCGA_annotated # output file prefix
VCF=merge.IDT-samples_TCGA_annotated.vcf.gz  # bgzipped and tabix indexed
BED=target_regions/hg38_IDT_targets_sorted_merged_extended_sorted_merged.bed  # capture bed file
BEDNAME=IDT  # output name for capture
